                                 ...
                                 MPIR_Errflag_t * errflag)
{
   ...
   if (PRINT_FUN_NAME || DEBUG_INIT_FILE){
    ...
    printf("[allreduce rank = %d host = %s count = %d] Func: MPID_Allreduce\n",
    comm->rank,hostname,count);fflush(stdout);}
#endif	
                                  ...
                                  MPIR_Request **request)
{
   ...
   if (PRINT_FUN_NAME || DEBUG_INIT_FILE){
    ...
    gethostname(hostname, MAX_HOSTNAME_LEN);
    printf("[allreduce rank = %d host = %s count = %d] Func: MPID_Iallreduce\n",
    comm->rank,hostname,count);fflush(stdout);}
#endif
