                     ...
                     int root, MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
   ...
   if (PRINT_FUN_NAME || DEBUG_INIT_FILE){
    ...
    if (inter_gather_tuning>0 && init_phase == 0){
        ...
        // if (DEBUG_INIT_FILE)  fprintf(stderr,"[%d] MPIR_Gather_impl 01 c=%d \n",init_rank,recvcount);
        // mpi_errno = MPIR_Gather_MV2_Direct_CHS(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm_ptr, errflag);
        // if (DEBUG_INIT_FILE)  fprintf(stderr,"[%d] MPIR_Gather_impl 02 c=%d \n",init_rank,recvcount);
        // mpi_errno = MPIR_Gather_intra(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm_ptr, errflag);
