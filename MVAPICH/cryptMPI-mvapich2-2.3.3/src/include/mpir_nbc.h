...
/*****     Added by Mehran      *****/
int MPID_Sched_crypt(const void *inbuf, const MPI_Aint in_len, const MPI_Aint enc_overhead, const MPI_Aint nonce_len, void *outbuf, MPI_Aint* out_len, const MPI_Aint max_out_len, const char opt, MPID_Sched_t s);
