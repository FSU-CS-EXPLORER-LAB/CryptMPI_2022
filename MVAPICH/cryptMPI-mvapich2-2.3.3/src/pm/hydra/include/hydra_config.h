...
/* Configure arguments */
#define HYDRA_CONFIGURE_ARGS_CLEAN "'--disable-option-checking' '--prefix=/home/sadeghil/Installed_Tools/CryptMPI' '--with-boringssl-include=/home/sadeghil/Installed_Tools/BoringSSL/boringssl-master/include/' '--cache-file=/dev/null' '--srcdir=.' 'CC=gcc' 'CFLAGS= -DNDEBUG -DNVALGRIND -O2' 'LDFLAGS=-L/lib -L/lib -L/lib -Wl,-rpath,/lib -L/lib -Wl,-rpath,/lib -L/lib -L/lib' 'LIBS=-libmad -lrdmacm -libumad -libverbs -ldl -lrt -lm -lpthread ' 'CPPFLAGS= -I/home/sadeghil/Encrypted_MPI/cryptMPI-mvapich2-2.3.3/src/mpl/include -I/home/sadeghil/Encrypted_MPI/cryptMPI-mvapich2-2.3.3/src/mpl/include -I/home/sadeghil/Encrypted_MPI/cryptMPI-mvapich2-2.3.3/src/openpa/src -I/home/sadeghil/Encrypted_MPI/cryptMPI-mvapich2-2.3.3/src/openpa/src -D_REENTRANT -I/home/sadeghil/Encrypted_MPI/cryptMPI-mvapich2-2.3.3/src/mpi/romio/include -I/include -I/include -I/include -I/include' 'MPLLIBNAME=mpl'"
